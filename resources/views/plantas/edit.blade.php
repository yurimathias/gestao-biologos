        ...
        <div class="container">
            <form action="{{ route('plantas.update', $planta->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nome_cientifico" value="{{ $planta->nome_cientifico }}" required>
                </div>
                <div class="form-group">
                    <x-input-label for="nome_comum" :value="__('Nome Comum')" />
                    <input type="text" name="nome_comum" value="{{ $planta->nome_comum }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="area_id" id="area_id">
                        ...
                        @foreach ($areas as $area)
                            <option value="{{ $area->id }}" @selected($planta->area_id == $area->id)>{{ $area->nome }}</option>
                        @endforeach
                    </select>
                </div>
